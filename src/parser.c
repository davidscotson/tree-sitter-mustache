...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inverted_section, 2, 0, 1),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inverted_section, 3, 0, 2),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_partial_statement, 4, 0, 4),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_path_expression_repeat1, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ampersand_statement, 4, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path_expression, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_set_delimiter_statement, 7, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__section_end, 4, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_triple_statement, 5, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_statement, 4, 0, 3),
  [94] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation_statement, 3, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section, 3, 0, 0),
  ...
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_section_begin, 4, 0, 0),
