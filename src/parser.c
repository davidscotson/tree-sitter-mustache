...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_inheritance_begin] = STATE(11),
    [sym_block_statement] = STATE(2),
    [sym_block_begin] = STATE(8),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inheritance_statement, 2, 0, 2),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inverted_section, 3, 0, 4),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inheritance_statement, 3, 0, 5),
  ...
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inheritance_begin, 4, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_begin, 4, 0, 0),
